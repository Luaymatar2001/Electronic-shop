...
<body>
  ...
  <div class="form-group">
                ...
                <div aria-label="breadcrumb " class="first  d-md-flex" >
                    <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
                        ...
                        <li class="breadcrumb-item font-weight-bold"><a class="black-text text-uppercase" href="#"><span >about</span></a><img class="ml-md-3" src="https://img.icons8.com/offices/30/000000/double-right.png" width="20" height="20"></li> -->
                            ...
                            <li class="breadcrumb-item font-weight-bold " ><li class="breadcrumb-item font-weight-bold mr-0 pr-0"><a class="black-text active-1" href="#"><span>Edit {{$idInfo->name}} Store</span></a> <img class="ml-md-3" src="https://img.icons8.com/offices/30/000000/double-right.png" width="20" height="20" style= "margin-top:15px"></li>
    ...
    <div class="container mt-5">
        <div class="card">
            <h5 class="card-header text-center">Edit the {{$idInfo->name}} store</h5>
            <div class="card-body">
                ...
                <form role="form" action = "{{URL('public/Dashboard/store/Update/'.$idInfo->id)}}" method = "post" enctype="multipart/form-data"  data-toggle="validator">
                  <input type="hidden" name = "_token" value = "{{csrf_token()}}">
                    <div class="form-group">
                        <label>Store name</label>
                        <input type="text" name = "name"  value = "{{$idInfo->name}}" class="form-control" id="inputName"  placeholder="Name" >
                        <!-- Error -->
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" name = "email" class="form-control" id="inputEmail" value = "{{$idInfo->Email}}" placeholder="Email" >
                        <!-- Error -->
                 ...
                 <div class="custom-file">
                    ...
                    <textarea class="form-control"  id="inputMessage"
                            placeholder="Message" name = "describe" >{{$idInfo->description}}</textarea>
                        <!-- Error -->
