        ...
        <div class="card">
            ...
            @if(session()->has('add_Status'))
                ...
                $(document).ready(function () {
                  swal({
                  icon: "success",
                  text: "The data modification process was completed successfully!",
                });
                })
                ...
                Modification failed
                   ...
                   @endif
                @endif
                <form role="form" action = "{{URL('public/Dashboard/product/update/'.$idInfo->id)}}" enctype="multipart/form-data" method = "post"   data-toggle="validator">
                  <input type="hidden" name = "_token" value = "{{csrf_token()}}">
                    <div class="form-group">
                        <label>Product name</label>
                        <input type="text" name = "name" class="form-control" data-error="You must have a name." id="inputName" placeholder="Product name" value = "{{$idInfo->name}}" required>
                        <!-- Error -->
                    ...
                    <div class="form-group">
                        <label> price </label>
                        <input type="text" name = "price" class="form-control" data-error="You must have a price." id="inputName" placeholder="price" value = "{{$idInfo->price}}"  required>
                        <!-- Error -->
                    ...
                    <div id = "discount" class="form-group" >
                        ...
                        <input type="text" name = "discount" class="form-control" data-error="You must have a discount." id="inputName" value = "{{$idInfo->discount}}" placeholder="discount" >
                        <!-- Error -->
              ...
              <div class="form-group">
                 ...
                 <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="inputGroupFile01" value = "{{$idInfo->image}}">Choose image</label>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="form-control" data-error="Please enter message." id="inputMessage"
                            placeholder="Description" name = "describe" >{{$idInfo->description}}</textarea>
                        <!-- Error -->
                 ...
                 <div class="form-group">
                        ...
                        <input type="text" name = "category" class="form-control" data-error="You must have a category." id="inputName" value = "{{$idInfo->category}}" placeholder="category" required>
                        <!-- Error -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name = "quantity" value ="{{$idInfo->quantity}}" class="form-control" data-error="You must have a name." id="inputName" placeholder="quantity" required>
                        <!-- Error -->
